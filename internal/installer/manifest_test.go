...
func TestManifestHasStableBaselineAndIndependentOptions(t *testing.T) {
	...
	for _, id := range []string{"communication-discord", "communication-slack", "media-spotify", "media-vlc", "desktop-chrome", "service-mysql", "service-postgresql", "service-redis", "service-sqlite", "ai-herdr"} {
		if !seen[id] {
