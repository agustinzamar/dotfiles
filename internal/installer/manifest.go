...
func Components() []Component {
	return []Component{
		...
		{ID: "laravel", Label: "Laravel and Herd", Category: "PHP", Commands: []string{"brew install laravel Herd"}, Dependencies: []string{"php"}},
		...
		{ID: "phpstorm", Label: "PHPStorm", Category: "PHP", Commands: []string{"brew install --cask phpstorm"}},
