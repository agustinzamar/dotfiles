...
func Components() []Component {
	return []Component{
		...
		{ID: "git", Label: "Git and configuration", Category: "Git", Default: true, Links: []string{"git", "lazygit", "hunk"}, Commands: []string{"brew install git gh lazygit git-delta hunk", "dot git"}},
